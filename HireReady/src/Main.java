public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Coding Score         : " +
        ...
        if (!degreeEligible) {
            ...
            System.out.println("Application Status : Not Eligible");
            System.out.println("Next Action        : Check the eligible graduation year.");
